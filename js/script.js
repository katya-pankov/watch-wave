...
async function displayPopularMovies() {
    ...
    results.forEach((movie) => {
        ...
        <a href="movie-details.html?id=${movie.id}">
          ${movie.poster_path
                ? `<img src="https://image.tmdb.org/t/p/w500${movie.poster_path}" class="card-img-top" alt="${movie.title}" />` : `<img src="images/logo-black-no-img.png" class="card-img-top" alt="${movie.title}" />`
            }
        </a>
        <div class="card-body">
...
async function displayPopularShows() {
    ...
    results.forEach((show) => {
        ...
        <a href="tv-details.html?id=${show.id}">
          ${show.poster_path
                ? `<img src="https://image.tmdb.org/t/p/w500${show.poster_path}" class="card-img-top" alt="${show.name}" />` : `<img src="images/logo-black-no-img.png" class="card-img-top" alt="${show.name}" />`
            }
        </a>
        <div class="card-body">
